...
const Home = () => {
  ...
  const [searchededResults , setSearchedResults] = useState(null)
    ...
    <section className="max-w-7xl mx-auto">
        ...
        <div className='mt-10'>
            {loading ? (
                ...
                <>
                    {searchText && (
                        <h2 className='font-medium text-[#666e75] text-xl mb-3'>Shoing results for <span className='text-[#222328]'>{searchText}</span></h2>
                    )}
                    <div className='grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3'>
                        { searchText ? (
                            <RenderCards
                             data={searchededResults}
